 ...
 * $this->EE->nsm_better_meta->addCSS('custom_field.css');
 * 
 * # Load the JS for the iframe
 * $this->EE->nsm_better_meta->addJS('custom_field.js');
 * $this->EE->nsm_better_meta->addJS('../lib/jquery.cookie.js');
 * 
