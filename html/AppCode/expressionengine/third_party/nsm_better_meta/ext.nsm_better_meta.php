...
class Nsm_better_meta_ext
{
	...
	static $meta_table_fields = array(
		...
		'keywords_append_default'	=> array( 'type' => 'tinyint', 'constraint' => '1', 'default' => '0'),
		...
		// robots meta
		'robots_index'					=> array( 'type' => 'tinyint', 'constraint' => '1', 'default' => '0' ),
		'robots_follow'					=> array( 'type' => 'tinyint', 'constraint' => '1', 'default' => '0' ),
		'robots_archive'				=> array( 'type' => 'tinyint', 'constraint' => '1', 'default'  => '0' ),
		// sitemap meta
		'sitemap_priority'				=> array( 'type' => 'double', 'constraint' => '2,1', 'default' => '0.5' ),
		'sitemap_change_frequency'		=> array( 'type' => 'varchar', 'constraint' => '20'),
		'sitemap_include'				=> array( 'type' => 'tinyint', 'constraint' => '1', 'default' => '0' ),
		// geo meta
	...
	public	function settings_form()
	{
		...
		$EE->nsm_better_meta->addJS('extension_settings.js');
		...
		{
			if(!isset($data["channels"][$channel->channel_id]))
			{
				$data["channels"][$channel->channel_id] = $this->_buildChannelSettings($channel->channel_id);
			}
