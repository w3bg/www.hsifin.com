...
class Nsm_better_meta_tab
{
	...
	public function publish_tabs($channel_id, $entry_id = FALSE)
	{
		if(!class_exists('Nsm_better_meta_ext'))
			require(PATH_THIRD . "nsm_better_meta/ext.nsm_better_meta.php");
		...
		if(isset($this->EE->cp))
		{
			...
			$this->EE->nsm_better_meta->addJS('extension_settings.js');
		}
	...
	public function publish_data_db($params)
	{
		...
		if (isset($params["mod_data"]["meta"]) === FALSE) return;
